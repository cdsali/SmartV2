...
import vid from "../../Assets/intro.webm";
...
const Section = () => {
  ...
  return (
    ...
    <Row className="section-images container " style={{left:"0",right:"0",margin:"auto"}} >
      ...
      <Col md={5}  className="d-flex flex-column justify-content-center ord1">
...
<ul >
      ...
      <div className="video-wrapper" style={{display:"none"}}>
                <video controls className="video" width="100%">
                    <source src={vid} type="video/mp4" />
                    Your browser does not support the video tag.
                </video>
            </div>
